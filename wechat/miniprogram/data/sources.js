...
const sourcesById = {
  ...
  "xhs_ds_hunzi_qing": {
    ...
    "course_reviews": {
      "SDSC6006": "可以远程完成，时间看想做成什么水平。可以和mentor讨论投稿方向。考核为论文。"
    }
  },
  "xhs_ds_qiu_zhu": {
    ...
    "course_reviews": {
      "SDSC6012": "比王燕老师讲的时间序列简单，统计专业无压力。给分友好。"
    }
  },
  "xhs_ds_sema_gawin": {
    ...
    "course_reviews": {
      "SDSC5001": "没有ML基础也能跟上，但画图题易掉坑，树和SVM部分需认真学。项目很水给分挺高，但会curve，部分同学不满意。考试有最低通过要求，闭卷考试。",
      "SDSC5002": "水课，强烈推荐！老师在变着法子送分。有项目要pre，可视化内容不多，跟其他课有交叉。考核为考试+项目。",
      "SDSC5003": "跟本科数据库内容一致，多了MapReduce概念，不需搭环境。本科学过数据库则无压力。老师严格按原始分给分，不curve。开卷考试。",
      "SDSC6012": "比王燕老师讲的时间序列简单，统计专业无压力。神经网络部分讲RNN/LSTM/GRU，难度不大。作者数学一般也拿了B+，给分友好。闭卷考试。"
    }
  },
  "xhs_ds_semb_gawin": {
    ...
    "course_reviews": {
      "SDSC6004": "院主任授课，上课佛系口音舒服。讲基础ML/DL加智慧城市各方面知识。期末开卷，推荐选。可能有出勤分。",
      "SDSC6013": "适合非商科背景，老师讲得比较慢。老师之前在雷曼兄弟工作，风格随意，喜欢交流市场。固收基础加风险基础，no exam纯项目制。注意2025年底有学生反馈难度大增，不再是纯水课。",
      "SDSC6016": "老师宾大本硕加芝加哥博，口音很舒服。Mid很简单，学过SDSC6012或本科时间序列可裸考。注意没有Zoom没有Recording，不适合远程上课。闭卷考试。"
    }
  },
  "xhs_ds_xuanke_buyao": {
    ...
    "course_reviews": {
      "SDSC6011": "考试占比80%，需扎实数学基础。有学生明确建议避开此课（避雷）。考核以考试为主。",
      "SDSC6013": "2025年底有学生反馈难度大增，不再是纯水课。"
    }
  }
};
