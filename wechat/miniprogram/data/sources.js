...
const sourcesById = {
  "cs_ec_sema_review_2": {
    ...
    "course_reviews": {
      "CS5285": "虽说没有 group project，但是也是很难，看选了的同学也是各种后悔，叫苦不迭，还速成不了，没基础的期末简直是看天书，而且课还是在周五晚上就很阴间，建议是别选。"
    }
  },
  "cs5285_4A": {
    "source_id": "cs5285_4A",
  ...
  "cs5285_ds_settle": {
    ...
    "course_reviews": {
      "CS5285": "CS5285：硬 但是汉克赛高！！！！ 老师讲了十一年这门课了，课程安排和课程体系非常成熟，内容很丰富。主要内容：基础密码-密钥交换/管理/身份认证基础计算机安全/网络安全\n无代码，但是知识点较多。感兴趣并且想学东西是真的能学得到\n((((*｡_｡)也是我最喜欢也是付出时间最多的课！！"
    }
  },
  "cs5285_info_sec": {
    "source_id": "cs5285_info_sec",
  ...
  "cs5487_ee_eval": {
    ...
    "course_reviews": {
      "CS5487": "CS5487 机器学习，这门课真的很难，和博士一起上课，ds，cs，数学，ee多个院一起。是从底层数学推导不同机器学习算法。没有ppt，老师会在课上板书。每周都有作业，有时候感觉是一题都不会，这门课花的时间最多，需要有较好的数学基础，机器学习理论基础。可以B站上参考下机器学习白板推导。当然我也看有人评价，专注底层逻辑收获很大。\nEE院也有一门机器学习，看大家反馈偏应用，好上手。更推荐这个。"
    }
  },
  "cs5487_phd_eval": {
    "source_id": "cs5487_phd_eval",
  ...
  "cs6290_semb_4A": {
    ...
    "course_reviews": {
      "CS6290": "好课。主要探讨区块链技术和原理，平时分是四份阅读报告，四个小测，和一个小组作业。老师对AI非常包容，不要直接把AI输出交上去贴脸开大就行了。小组作业有大神队友带着拿了全班最高分，爽死了。开卷考试只能带两张A4纸，难度低但题量大。遇到有题目一分钟也想不出怎么做就要跳题，千万别犹豫，两小时不断写就完了。"
    }
  },
  "cs6290_st_eval": {
    "source_id": "cs6290_st_eval",
  ...
  "cs6493_cs_semb": {
    ...
    "course_reviews": {
      "CS6493": "非常好的老师，非常好的课，唯一的问题就是我，我学不懂。项目挑的最水的，上课是听不懂的，课件是真的很多的，教的内容挺新的，包括Transformer、GPT、RAG等。会有作业和小组作业，小组作业的话，有一定基础的同学会做起来轻松很多。期末感觉挺难，考的挺广，闭卷，会有代码题（出自tutorial，但我看了也不会）、概念解释，场景题，计算题（出自作业）。可以结合网上资料复习等等，我是倾向了解大概即可，不必死磕。"
    }
  },
  "cs6493_hunzi": {
    "source_id": "cs6493_hunzi",
    ...
    "course_reviews": {
      "CS6493": "cs6493 nlp：和上学期的de一个老师，整体流程也差不多，两次作业，一次给分不高但也不难的project，闭卷考试。虽然老师说要理解概念不能死记硬背，但背就完事了，代码题可以碰碰运气，今年考的就比较简单。"
    }
  },
  "cs6493_selection_3": {
    "source_id": "cs6493_selection_3",
  ...
  "ec_review": {
    ...
    "course_reviews": {
      "CS5285": "应该是SemA上过的最难的一门课。涉及的知识点又多又难，有两个problem set，一次开卷的期中考试，和能带一页cheatsheet的期末考试，🈚考勤🈚project。还好Hancke老师人很不错，给分也好：\"If there's something on your paper, I can imagine it's the right answer.\" Hancke老师课后还会给出每节课的note，明确标注哪些是重点，哪些不需要掌握。总之学的痛并快乐着。(提醒：2次problem set题量特别大，千万不要拖到ddl前一天才开始做！)"
    }
  },
  "ec_sema_course_review": {
    "source_id": "ec_sema_course_review",
    "title": "港城 EC SemA 课程简评",
    "url": "http://xhslink.cn/o/2QfQMpxDKX",
    "platform": "小红书",
    "note": "记录 CS5285 的作业、期中与期末考核形式。",
    "course_reviews": {
      "CS5285": "好课，两次assignment占20%+一次开卷midterm占20%+一次可带双面cheatsheet的期末考试占60%，老师期末会捞人。"
    }
  },
  "ec_sharp": {
    "source_id": "ec_sharp",
  ...
  "ec_update": {
    ...
    "course_reviews": {
      "CS5285": "密码学与网络安全。很难，可惜是EC必修课不得不选，无考勤、有回放（虽然没看过）。2次个人作业，1次开卷期中考，期末1页cheatsheet。通过应该还是相对容易（老师很善良：只要你写了，我会想象它是对的）。"
    }
  },
  "sema_st_selection": {
    "source_id": "sema_st_selection",
    ...
    "course_reviews": {
      "CS5487": "CS5487 ML理论：25级学期 A 变成了ML实践，但形式应该还是Atoni大佬+新老师，听着费劲的可以去开小灶 -> B站白板推导。",
      "CS6290": "CS6290 Privacy：读了区块链很多论文，Proj也可以论文调研，总体给分不错。"
    }
  },
  "sutong_guide": {
    "source_id": "sutong_guide",
    ...
    "course_reviews": {
      "CS6493": "CS6493 NLP 必选！基本有ai背景的就是学一学理论。",
      "CS6290": "CS6290 Privacy-enhancing Technology 必选！日常任务完全拥抱ai，且平时分占比高。期末考开卷且基本抄了就能会，项目自由度很高"
    }
  },
  "xhs_ds_hunzi_qing": {
    "source_id": "xhs_ds_hunzi_qing",
    "title": "CityU 24Fall DS混子完结撒花 评论区 (晴可可)",
    "url": "https://www.xiaohongshu.com/explore/68b0296a000000001d010a16",
    "platform": "小红书",
    "note": "DS 混子完结总结评论区，涉及 DSC6006 论文课与 SDSC6007/8013 等课程评价。",
    "course_reviews": {
      "DSC6006": "可以远程完成，时间看想做成什么水平。可以和mentor讨论投稿方向。考核为论文。"
    }
  },
  "xhs_ds_qiu_zhu": {
    "source_id": "xhs_ds_qiu_zhu",
    ...
    "course_reviews": {
      "DSC6012": "比王燕老师讲的时间序列简单，统计专业无压力。给分友好。"
    }
  },
  "xhs_ds_sema_gawin": {
    "source_id": "xhs_ds_sema_gawin",
    "title": "CityU DS SemA 学渣版分享 (一只Gawin)",
    "url": "https://www.xiaohongshu.com/explore/677e0f320000000020022685",
    "platform": "小红书",
    "note": "DS SemA 课程体验汇总，涉及 DSC5001/5002/5003/6012 等课程难度、给分与考核方式。",
    "course_reviews": {
      "DSC5001": "没有ML基础也能跟上，但画图题易掉坑，树和SVM部分需认真学。项目很水给分挺高，但会curve，部分同学不满意。考试有最低通过要求，闭卷考试。",
      "DSC5002": "水课，强烈推荐！老师在变着法子送分。有项目要pre，可视化内容不多，跟其他课有交叉。考核为考试+项目。",
      "DSC5003": "跟本科数据库内容一致，多了MapReduce概念，不需搭环境。本科学过数据库则无压力。老师严格按原始分给分，不curve。开卷考试。",
      "DSC6012": "比王燕老师讲的时间序列简单，统计专业无压力。神经网络部分讲RNN/LSTM/GRU，难度不大。作者数学一般也拿了B+，给分友好。闭卷考试。"
    }
  },
  "xhs_ds_semb_gawin": {
    "source_id": "xhs_ds_semb_gawin",
    "title": "CityU DS SemB 分享 (一只Gawin)",
    "url": "https://www.xiaohongshu.com/explore/68303e95000000002102e3bc",
    "platform": "小红书",
    "note": "DS SemB 课程体验汇总，涉及 DSC6004/6013/6016 等课程评价。",
    "course_reviews": {
      "DSC6004": "院主任授课，上课佛系口音舒服。讲基础ML/DL加智慧城市各方面知识。期末开卷，推荐选。可能有出勤分。",
      "DSC6013": "适合非商科背景，老师讲得比较慢。老师之前在雷曼兄弟工作，风格随意，喜欢交流市场。固收基础加风险基础，no exam纯项目制。注意2025年底有学生反馈难度大增，不再是纯水课。",
      "DSC6016": "老师宾大本硕加芝加哥博，口音很舒服。Mid很简单，学过6012或本科时间序列可裸考。注意没有Zoom没有Recording，不适合远程上课。闭卷考试。"
    }
  },
  "xhs_ds_xuanke_buyao": {
    "source_id": "xhs_ds_xuanke_buyao",
    "title": "球CityU DS专业选课推荐 评论区",
    "url": "https://www.xiaohongshu.com/explore/68988a1e0000000023033fed",
    "platform": "小红书",
    "note": "DS 选课推荐评论区，涉及 DSC6011 避雷、DSC6012/6013 等课程讨论。",
    "course_reviews": {
      "DSC6011": "考试占比80%，需扎实数学基础。有学生明确建议避开此课（避雷）。考核以考试为主。",
      "DSC6013": "2025年底有学生反馈难度大增，不再是纯水课。"
    }
  }
};
