...
const courses = [
  ...
  },
  {
    ...
    "recommendation": {
      ...
      "level": "neutral",
      "verdict": "无回放需注意",
      "summary": "老师宾大本硕加芝加哥博，口音很舒服。Mid 很简单，学过 6012 或本科时间序列可裸考。注意：没有 Zoom 没有 Recording，不适合远程上课。闭卷考试。",
      "tags": [
        "难度适中",
        "闭卷考试",
        "无回放",
    ...
    "sourceReviews": [
      {
        "sourceId": "xhs_ds_semb_gawin",
        "text": "老师宾大本硕加芝加哥博，口音很舒服。Mid很简单，学过6012或本科时间序列可裸考。注意没有Zoom没有Recording，不适合远程上课。闭卷考试。",
        "title": "CityU DS SemB 分享 (一只Gawin)",
        "url": "https://www.xiaohongshu.com/explore/68303e95000000002102e3bc",
        "platform": "小红书",
        "note": "DS SemB 课程体验汇总，涉及 DSC6004/6013/6016 等课程评价。"
